...
module Standard
  # Displays version information for the server software running on a given
  # server or the current server if no argument is specified
  class Version
    def initialize
      @command_name = 'version'
      @command_proc = proc { |user, args| on_version(user, args) }
    end
